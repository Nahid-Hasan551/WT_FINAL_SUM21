...
<?php 
    include ('controllers/reportcustomer.php');
?>
...
<form class="" action="" method="post" >
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="radio" id="rate" name="rate" value="verygood">
            <label for="rate">Very good</label>
            <input type="radio" id="rat" name="rate" value="good"> <label for="rat">Good</label>   
            <input type="radio" id="rat" name="rate" value="bad">
