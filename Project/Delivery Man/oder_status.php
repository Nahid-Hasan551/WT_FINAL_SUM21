<?php
    include 'controllers/oderstatuscontrollers.php';
?>
<html>
...
<form class="" action="" method="post">
    ...
    <table width = "40%" align="center" >
        ...
        <tr >
            <td ><h3>Enter Order ID: </h3></td>  <td><input type="text" name="oderid"></td>
        </tr>
        ...
        <tr>
            <td></td> <td><input type="radio" id="ongoing" name="check" value="ongoing"> <label for="chec" >Oder Ongoing</label> </td>
        </tr>

        <tr>
            <td></td><td><input type="radio" id="deviverd" name="check" value="deliverd"> <label for="chec" >Delivered</label> </td>
        </tr>
