    ...
    <script src="js/alert_massage.js"></script>
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <table align="center">
          ...
          <tr>
            <!--<td align="center"><input type="submit" class="btn btn-info" name="confirm_product"value="Confirm" ></td>-->
            <td align="center"><a href="all_order.php" class="btn btn-info">Confirm</a></td>
          </tr>
