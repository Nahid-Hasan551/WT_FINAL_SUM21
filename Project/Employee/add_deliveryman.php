...
<h5> <?php echo $err_db;?> </h5>
	<form action="" onsubmit="return validate()" method="post" enctype="multipart/form-data">
        ...
        <table align="center">
          ...
          <tr>
            <td>Username</td>
            <td>: <input id="uname" type="text" name="username" onfocusout="checkUsername(this)" value="<?php echo $uname;?>" ><br>
            <span id="err_uname" style="color:red;"><?php echo $err_uname;?></span></td>
          </tr>

          <tr>
            <td>Password</td>
            <td>: <input id="pass" name="password" value="<?php echo $pass;?>" type="password" >
          ...
          <tr>
            <td > Phone </td>
            <td>
              : <input id="phone_num" type="text" name="phone_num" value="<?php echo $phone_num;?>">
...
<!--
          ...
          <tr>
            <td></td>
             <td align="center"><input type="submit" class="btn btn-success" name="add_user" value="Add DeliveryMan" ></td>
          </tr>
...
<script src="js/add_deliverymen.js"></script>